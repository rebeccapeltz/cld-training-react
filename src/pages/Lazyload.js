...
function LazyLoad() {
    ...
    return (
        <div className={'mr-2'}>
            ...
            <p style={{"margin-top":"1rem", "font-family": "courier", "background-color": "black", color: "white" }}>
                {`const brownSheep = new CloudinaryImage("brown_sheep", { cloudName: "demo" });`}
            </p>
            <p style={{ "font-family": "courier", "background-color": "black", color: "white" }}>
                {
                    `brownSheep.resize(crop().width(400).height(400).gravity(autoGravity()));`
                }
            </p>
            ...
            <AdvancedImage style={{ display: "block", "marginTop": "600px", width: "400px", height: "400px" }} cldImg={brownSheep} plugins={[lazyload({ rootMargin: '20px 20px 20px 20px', threshold: 0.25 })]} />
            <AdvancedImage style={{ display: "block", "marginTop": "600px", width: "400px", height: "400px" }} cldImg={cat} plugins={[lazyload({ rootMargin: '20px 20px 20px 20px', threshold: 0.25 })]} />
            <AdvancedImage style={{ display: "block", "marginTop": "600px", width: "400px", height: "400px" }} cldImg={woman} plugins={[lazyload({ rootMargin: '20px 20px 20px 20px', threshold: 0.25 })]} />
            <AdvancedImage style={{ display: "block", "marginTop": "600px", width: "400px", height: "400px" }} cldImg={bear} plugins={[lazyload({ rootMargin: '20px 20px 20px 20px', threshold: 0.25 })]} />
        </div>
    );
}
