...
export default function RenderingAdvancedImage() {
  return (
    <div className="code-container">
      ...
      <p  className={"font-sans mt-1 mb-1 text-clddarkblue"}>All Cloudinary assets are delivered via CDN.  This is a big step in optimization. The AdvancedImage component
