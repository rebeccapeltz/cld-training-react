  ...
  return (
    <div className="code-container">
      ...
      <p className={"font-sans mt-1 mb-1 text-clddarkblue"}>
        ...
        optimization. The AdvancedVideo component creates an HTML5 video
        elements. You can include HTML5 video attributes such as control, to add
        controls to the video. You only need to specify a Cloudinary Cloud Name
        and Public ID to create an video object. Once you have that object, you
        can hand it off to the AdvancedVideo component to render it.{" "}
      </p>
